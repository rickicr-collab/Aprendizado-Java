...
/*
 * COMENTÁRIOS SOBRE A NOVA CLASSE PATH:
 * 
 * NESSA NOVA CLASSE FOI CRIADO AS FORMAS PARA SE DECLARA AS FORMAS PARA O CAMINHO ABSOLUTO
 * DE ARQUIVO NO COMPUTADOR ONDE SE PODE SEPARA CADA VALOR COMO STRING DE FORMA COMO 
 * ARGUMENTOS USANDO CARACTERE VIRGULA PARA SEPARAÇÃO ISSO TORNA O CODIGO MAIS LIMPO 
 * SEM A NECESSIDADE DE USAR MUITAS CONTRA-BARRAS.
 * 
 * PARA CRIAR UM UNICO DIRETORIO:  USE O METODO FILES.CREATENEWDIRECTORY();
 * PARA CRIAR MAIS DE UM UNICO DIRETORIO: USE O MÉTODO FILES.CREATENEWDIRECTORIES();
 * 
 * OBS:  NA FUNÇÃO FILES, COPY() →  EXISTE UM ARGUMENTO CHAMADO OPTIONS ONDE VOÊ PODE
 * DA COMANDO E INSTRUÇOES PARA DAR REPLACE NO ARQUIVO EXECUTADO NA AÇÃO USANDO O COMANDO
 * STANDARTCOPYOPTION.REPLACE_EXISTING.
 * 
 * PRINCIPAIS MUDANÇAS COM A CLASSE PATH E FILES:
 * 
 * 
 * 
 */
